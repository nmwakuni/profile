...
const about = () => {
  return (
    <div className="w-full h-full">
      <div className="w-full h-screen bg-opacity-60 mb-5 bg-black relative before:content-[''] before:bg-[url(/about.jpg)] before:bg-cover before:bg-center before:w-full before:h-full before:absolute before:top-0 before:left-0 before:-z-1">
