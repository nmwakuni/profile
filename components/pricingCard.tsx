  ...
  return (
    <div className="w-full px-4 text-gray-200 py-15">
      <div className="m-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="text-center p-4 bg-black hover:bg-gray-800 border border-white">
        ...
        <div className="text-center hover:bg-gray-800 bg-black border border-white p-4">
